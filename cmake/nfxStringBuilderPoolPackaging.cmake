#==============================================================================
# nfx-stringbuilderpool - Library packaging configuration (CPack)
#==============================================================================
...
if(NOT NFX_STRINGBUILDERPOOL_PACKAGE_SOURCE
		AND NOT NFX_STRINGBUILDERPOOL_PACKAGE_ARCHIVE
		AND NOT NFX_STRINGBUILDERPOOL_PACKAGE_DEB
		AND NOT NFX_STRINGBUILDERPOOL_PACKAGE_RPM
		AND NOT NFX_STRINGBUILDERPOOL_PACKAGE_WIX)
...
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY   "High-performance C++20 library for zero-allocation string building with thread-safe pooling")
...
set(CPACK_RESOURCE_FILE_LICENSE         ${NFX_STRINGBUILDERPOOL_LICENSE_FILE})
...
if(NFX_STRINGBUILDERPOOL_PACKAGE_SOURCE)
...
set(CPACK_PACKAGE_INSTALL_REGISTRY_KEY  "nfx-stringbuilderpool")
...
if(NOT DEFINED CPACK_GENERATOR)
	...
	# --- Archive packages ---
	if(NFX_STRINGBUILDERPOOL_PACKAGE_ARCHIVE)
	...
	# --- DEB packages ---
	if(NFX_STRINGBUILDERPOOL_PACKAGE_DEB AND UNIX AND NOT APPLE)
	...
	# --- RPM packages ---
	if(NFX_STRINGBUILDERPOOL_PACKAGE_RPM AND UNIX AND NOT APPLE)
	...
	# --- WiX packages ---
	if(NFX_STRINGBUILDERPOOL_PACKAGE_WIX AND WIN32)
...
if("RPM" IN_LIST CPACK_GENERATOR AND UNIX AND NOT APPLE)
	...
	set(CPACK_RPM_PACKAGE_LICENSE       ${NFX_STRINGBUILDERPOOL_LICENSE})
...
if("WIX" IN_LIST CPACK_GENERATOR AND WIN32)
	set(CPACK_WIX_PATCH_FILE "${CMAKE_BINARY_DIR}/wix_path.xml")
	file(WRITE "${CPACK_WIX_PATCH_FILE}"
		"<?xml version='1.0' encoding='UTF-8'?>\n"
		"<CPackWiXPatch>\n"
		"  <CPackWiXFragment Id=\"CM_CP_bin.nfx_stringbuilderpool.dll\">\n"
